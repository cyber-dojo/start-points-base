...
test_language_repo_manifest_contains_bad_json()
{
  ...
  assert_stderr_includes "filename='languages-python-unittest/start_point/manifest.json'"
...
test_exercise_repo_manifest_contains_bad_json()
{
  ...
  assert_stderr_includes "filename='exercises-bowling-game/manifest.json'"
