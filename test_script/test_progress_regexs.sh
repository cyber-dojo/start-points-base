...
test_failure_int_array()
{
  ...
  assert_stdout_includes "--languages ${tmp_url}"
  assert_stdout_includes "manifest='languages-csharp-nunit/start_point/manifest.json'"
  assert_stdout_includes '"progress_regexs": [1, 2]'
  # assert_stderr_line_count_equals 4
  assert_status_equals "${error_code}"
}
...
test_failure_empty_array()
{
  ...
  assert_stdout_includes "--languages ${tmp_url}"
  assert_stdout_includes "manifest='languages-csharp-nunit/start_point/manifest.json'"
  assert_stdout_includes '"progress_regexs": []'
  # assert_stderr_line_count_equals 4
  assert_status_equals "${error_code}"
}
...
test_failure_bad_regex()
{
  ...
  refute_image_created
  assert_stdout_includes 'ERROR: progress_regexs[1]="(" cannot create Regexp'
  assert_stdout_includes "--languages ${tmp_url}"
  assert_stdout_includes "manifest='languages-csharp-nunit/start_point/manifest.json'"
  assert_stdout_includes '"progress_regexs": ["OK", "("]'
  # assert_stderr_line_count_equals 4
  assert_status_equals "${error_code}"
}
